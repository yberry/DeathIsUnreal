...
#if ( defined( AK_WIN ) && (!defined( AK_USE_METRO_API ) || _MSC_VER >= 1900)) || defined AK_PS4 || defined AK_XBOXONE || defined AK_XBOX360 || defined AK_ANDROID || defined AK_APPLE || defined AK_LINUX
